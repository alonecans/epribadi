   ...
   nuy.on('chat-update', async (mek) => {
      try {
         ...
         if (messagesLink.includes('@6283815956151')) {
            // respon tag ubah aja
            reply(`*maaf ${pushname2}, admin manca-bot tidak menerima tag ehhehe*`)
            const d = fs.readFileSync('./sticker/nurul.webp')
            nuy.sendMessage(from, d, sticker, {quoted: mek})
         }
         if (messagesLink.includes('nurul')) {
            // respon tag ubah aja
            reply(`*maaf ${pushname2}, admin manca-bot tidak menerima panggil ehhehe chat aja langsung*`)
            const d = fs.readFileSync('./sticker/nurul.webp')
            nuy.sendMessage(from, d, sticker, {quoted: mek})
         }
         if (messagesLink.includes('@6283895164192')) {
            // respon tag ubah aja
            reply(`*maaf ${pushname2}, panggil Manca Aja, Manca tidak menerima tag! hehehe*`)
            const d = fs.readFileSync('./sticker/mancabot.webp')
            nuy.sendMessage(from, d, sticker, {quoted: mek})
         }
         ...
         if (messagesLink.includes('koin')) {
            nuy.updatePresence(from, Presence.composing)
            const loli = fs.readFileSync('./mp3/koin.mp3')
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true })
         }
...
♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}antivirtex [on/off]
...
♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}mugfloᴡer
♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}narutobanner
...
♡ۣۜۜ፝͜͜͡͡✿➤ KALO GA ADA DI MENU JANGAN KETIK!`,
               ...
               nuy.sendMessage(from, Menu, text, {quoted: mek})
            case 'zodiak':
            ...
            case 'cogan':
               ...
               try {
                  ...
                  nuy.sendMessage(from, pok, image, {
                     quoted: mek,
                     caption: `Wah Mantap Neh Buat Ciwi² :v`,
                  })
                  await limitAdd(sender)
               } catch {
                  reply(mess.wait)
           ...
           case 'galaxstyle':
            ...
            case 'kucing':
               ...
               nuy.sendMessage(from, buff, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "Halo User Manca Bot", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": "https://raw.githubusercontent.com/setyawan12/gambarmboh/master/gambarmanca.jpg"}}}})
               await limitAdd(sender)
               break
